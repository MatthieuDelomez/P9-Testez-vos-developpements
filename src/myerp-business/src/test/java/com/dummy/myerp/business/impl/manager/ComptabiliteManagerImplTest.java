...
public class ComptabiliteManagerImplTest {
	...
	//MOCK DU PROXY DAO
	private final DaoProxy daoProxyMock= mock(DaoProxy.class);
	
	//MOCK DU TRANSACTION MANAGER
	private final TransactionManager transactionManagerMock= mock(TransactionManager.class);
	
	//MOCK DE COMPTADAO
	private final ComptabiliteDaoImpl comptaDaoMock = mock(ComptabiliteDaoImpl.class);
	...
	when(this.transactionManagerMock.beginTransactionMyERP()).thenReturn(null);
                     ...
                     */
                      ...
                      vEcritureComptable.getListLigneEcriture().add(new LigneEcritureComptable(new CompteComptable(1), null, new BigDecimal(123.42),null));
        
                      vEcritureComptable.getListLigneEcriture().add(new LigneEcritureComptable(new CompteComptable(2), null, null,new BigDecimal(123.42)));
                      ...
                      */
                      ...
                      vEcritureComptable.getListLigneEcriture().add(new LigneEcritureComptable(new CompteComptable(2), null, null,new BigDecimal(1235)));
                      ...
                      */
                      ...
                      vEcritureComptable.setReference("AC-2019/00123");
                      ...
                      */
                      ...
                      vEcritureComptable.setReference("BQ-2019/00123");
                     ...
                     */
                      ...
                      vEcritureComptable.getListLigneEcriture().add(new LigneEcritureComptable(new CompteComptable(1), null, new BigDecimal("123.124"), null));
        
                      vEcritureComptable.getListLigneEcriture().add(new LigneEcritureComptable(new CompteComptable(2), null, null, new BigDecimal("123.124")));
    	...
    	EcritureComptable vEcritureComptable;
                      ...
                      daoEcritureComptable.setReference("AC-2019/00123");
