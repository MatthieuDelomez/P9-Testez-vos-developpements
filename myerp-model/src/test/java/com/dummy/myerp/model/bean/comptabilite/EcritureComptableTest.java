...
public class EcritureComptableTest {
    ...
    public  void isEquilibree() {
        ...
        /*
        Nous allons vérifier via une assertTrue si l'écriture est équilibrée
        */
        ...
        vEcriture.setLibelle("N'est pas équilibrée");
        ...
        Vérification que l'équilibre n'est pas équilibrée
